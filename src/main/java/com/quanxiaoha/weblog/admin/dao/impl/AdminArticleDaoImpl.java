...
public class AdminArticleDaoImpl implements AdminArticleDao {
    ...
    @Override
    public List<QueryArticleTypeRspDO> selectArticleType() {
        return articleMapper.selectArticleType();
    }

    @Override
    public List<String> selectVisitorArea() {
        return articleMapper.selectVisitorArea();
    }
}
